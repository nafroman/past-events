...
describe('HelloWorld.vue', () => {
    test('Web3 installed', () =>{
        expect(Web3.version).toEqual("1.0.0-beta.34");
    })
    test('Connectd to Infura Provider',()=>{
        const rpc = "https://mainnet.infura.io/v3/54e0b9ce0c11433f92b1ceb40151c888"
        const web3 = new Web3(rpc)
        expect(typeof web3 !== 'undefined').toBe(true)
    })
    test('contract gets past events',()=>{
        const rpc = "https://mainnet.infura.io/v3/54e0b9ce0c11433f92b1ceb40151c888"
        const web3 = new Web3(rpc)
            ...
            if(err){
              console.log(err)
                ...
                for(var i=0;i<result.length;i++){
                    events.push(result[i])//push event info to array
                } 
            }
            expect(Object.keys(events[1])).toEqual(expect.arrayContaining(['blockNumber', 'event']))
          })
